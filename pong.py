...
#Screen
wn = turtle.Screen()
wn.title("Pong by Debabrata Sahoo")
wn.bgcolor("black")
...
while True:
    ...
    #Vs Computer
    integer = random.randint(60, 65)
    diff = abs(paddle_b.ycor() - ball.ycor())
    if paddle_b.ycor() < ball.ycor() and diff > integer:
        paddle_b_up()

    elif paddle_b.ycor() > ball.ycor() and diff > integer:
        paddle_b_down()